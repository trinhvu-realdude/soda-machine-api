...
public class TransactionService {
    ...
    @Transactional
    public BaseResponseDto createTransaction(TransactionRequestDto transactionRequest) {
        try {
            ...
            return BaseResponseDto.builder().respCode("00").respMsg("Success").data(transactionResponseDto).build();
        } catch (Exception e) {
            log.error("Error: " + e.getMessage());
            return BaseResponseDto.builder().respCode("01").respMsg("Error").data(e.getMessage()).build();
        }
    }

    @Transactional
    public BaseResponseDto cancelTransaction(CancelTransactionRequestDto cancelTransactionRequestDto) {
        try {
            log.info("Start - /cancelTransaction");
            ...
            log.info("End - /cancelTransaction");
